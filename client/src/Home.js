...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {error ? (
        <p style={{ color: 'red' }}>
          <span role="img" aria-label="warning">🚨</span> Could not connect to server
        </p>
      ) : messages.length === 0 ? (
        <p>No barks yet... <span role="img" aria-label="sleeping">💤</span></p>
      ) : (
      ...
      <style>
        {`
          @keyframes pulseRed {
            ...
            50% { transform: scale(1.1); border-color: white; box-shadow: 0 0 20px red; }
          ...
          @keyframes pulseGreen {
            ...
            50% { transform: scale(1.1); border-color: white; box-shadow: 0 0 20px green; }
